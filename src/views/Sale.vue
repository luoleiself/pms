<template>
  <div>
    ...
    <div class="menu_box">
      <el-button type="primary" @click="add">添加销售记录</el-button>
    </div>
    <template>
      <el-table :data="tableOptions.tableData" :height="tableOptions.tableHeight" stripe border style="width: 100%" v-loading="tableOptions.loading" @selection-change="tblSelectionChange">
        ...
        <el-table-column prop="price" label="销售单价" align="center"></el-table-column>
        <el-table-column prop="amount" label="销售数量" align="center"></el-table-column>
